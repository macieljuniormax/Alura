...
let categoriesMock: [CategoryType] = [
    CategoryType(id: 1, name: "Restaurantes", image: "restaurantes"),
    CategoryType(id: 2, name: "Mercado", image: "mercado"),
    CategoryType(id: 3, name: "Farmácia", image: "farmacia"),
    CategoryType(id: 4, name: "Pet", image: "petshop"),
    CategoryType(id: 5, name: "Descontos", image: "descontos"),
    CategoryType(id: 6, name: "Bebidas", image: "bebidas"),
    CategoryType(id: 7, name: "Gourmet", image: "gourmet"),
]

let bannersMock: [BannerType] = [
    BannerType(id: 1, image: "barbecue"),
    BannerType(id: 2, image: "brazilian-meal"),
    BannerType(id: 3, image: "pokes"),
]
